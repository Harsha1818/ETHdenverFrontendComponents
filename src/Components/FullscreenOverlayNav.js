...
function FullscreenOverlayNav() {
  ...
  return (
    <div>
      <div className={`overlay fixed w-full h-full top-0 left-0 z-50 ${isOpen ? '' : 'hidden'}`} style={{ background: 'linear-gradient(rgb(54, 40, 169) 1.1%, rgb(188, 114, 209) 130%)', opacity: '0.8' }}>
